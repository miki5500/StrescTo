...
<html>
    <body>
        ...
        <main>
            <section class=" textfield1">
            <header>
            <h1>Tekst do streszczenia: </h1>
            </header>
            <div class="row">
                <form:form action="summarize" modelAttribute="article" method="POST">
                    <div class="col-sm-12 col-md-8 offset-md-1">
                        <figure>
                            <form:textarea path="article" rows="20" cols="400"/>
                        </figure>
                    </div>
                    <div class="col-sm-12 col-md-8 offset-md-1">
                        <figure>
                            <input type="submit" value="Summarize" class="save" />
                        </figure>
                    </div>
                </form:form>
            </div>
